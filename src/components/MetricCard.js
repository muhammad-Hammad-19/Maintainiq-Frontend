...
const toneIcons = {
  ...
  amber: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-amber-600 dark:text-amber-400">
  ...
  teal: (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-teal-600 dark:text-teal-400">
...
const iconBg = {
  blue: "bg-blue-50 dark:bg-blue-950/60",
  amber: "bg-amber-50 dark:bg-amber-950/60",
  teal: "bg-teal-50 dark:bg-teal-950/60",
  ...
  return (
    <article className={`metric metric-${tone}`}>
      <div className="metric-header">
        ...
        <div className={`metric-icon ${iconBg[tone] || iconBg.neutral}`}>
          {toneIcons[tone] || toneIcons.neutral}
        </div>
      </div>
      <strong>{value}</strong>
